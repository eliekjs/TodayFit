...
WHERE e.is_active = true
  AND e.slug IN (
    ...
    'australian_pull_up','ring_pull_up','weighted_pull_up','neutral_pull_up','wide_grip_pulldown','underhand_pulldown','inverted_row_feet_elevated','pendlay_row','yates_row','t_bar_row','db_shrug','cable_shrug','prone_y_raise','band_row','wall_angel',
...
WHERE e.is_active = true AND 'core' = ANY(e.primary_muscles)
  AND e.slug IN (
    ...
    'australian_pull_up','ring_pull_up','weighted_pull_up','neutral_pull_up','inverted_row_feet_elevated','pendlay_row','t_bar_row','wall_angel',
    'stir_the_pot','rollout_ab_wheel','dead_bug_band','pallof_rotation','side_plank_raise','bear_hold','plank_shoulder_tap','body_saw','reverse_crunch','dead_bug_single_arm',
    'front_rack_carry','trap_bar_carry','double_kb_front_carry','sandbag_carry','suitcase_deadlift',
