-- MMA: add starter_exercises tags so getPreferredExerciseNamesForSportAndGoals
-- ranks MMA-relevant exercises first (grip, hip stability, pull, explosive power, work capacity).
-- sport_tag_profile: mixed, grappling, striking, conditioning, strength_endurance, anaerobic_repeats, mobility, durability.
-- Research-backed (20250310100000): barbell_deadlift, barbell_back_squat, pullup, kb_swing.

-- Core research-backed: power/hinge/hip for takedowns and striking; pull + grip for grappling
...
-- Grip/carry and hip stability (grappling / clinch)
