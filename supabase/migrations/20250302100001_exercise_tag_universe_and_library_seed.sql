...
VALUES
  ...
  ('dead_stop_row', 'Dead Stop Row', ARRAY['pull'], ARRAY[]::text[], ARRAY['barbell'], ARRAY['strength'], 'pull', true),
  ('meadows_row', 'Meadows Row', ARRAY['pull'], ARRAY['core'], ARRAY['barbell'], ARRAY['strength'], 'pull', true),
  ...
  ('jm_press', 'JM Press', ARRAY['push'], ARRAY[]::text[], ARRAY['barbell','bench'], ARRAY['strength','hypertrophy'], 'push', true),
