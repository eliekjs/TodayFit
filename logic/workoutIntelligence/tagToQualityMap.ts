...
export const TAG_TO_QUALITY: Record<string, Partial<Record<TrainingQualitySlug, number>>> = {
  ...
  agility: { coordination: 0.75, balance: 0.6, plyometric_ability: 0.45 },
  speed: { rate_of_force_development: 0.55, power: 0.45, plyometric_ability: 0.35 },
  sprinting: { anaerobic_capacity: 0.6, rate_of_force_development: 0.5, power: 0.45 },
  acceleration: { rate_of_force_development: 0.65, power: 0.55 },
  reactive_power: { rate_of_force_development: 0.7, plyometric_ability: 0.55, balance: 0.4 },
  jumping: { plyometric_ability: 0.85, power: 0.65 },
