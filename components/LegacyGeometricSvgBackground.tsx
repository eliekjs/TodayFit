...
const PIECE_STYLES: PieceStyle[] = [
  { fill: "rgba(34,211,238,0.18)", top: "rgba(186,230,253,0.28)", left: "rgba(125,211,252,0.24)", bottom: "rgba(2,132,199,0.3)", right: "rgba(3,105,161,0.32)" },
  { fill: "rgba(250,204,21,0.22)", top: "rgba(254,240,138,0.3)", left: "rgba(253,224,71,0.28)", bottom: "rgba(202,138,4,0.32)", right: "rgba(161,98,7,0.34)" },
  { fill: "rgba(168,85,247,0.2)", top: "rgba(221,214,254,0.3)", left: "rgba(196,181,253,0.28)", bottom: "rgba(109,40,217,0.32)", right: "rgba(91,33,182,0.34)" },
  { fill: "rgba(59,130,246,0.18)", top: "rgba(191,219,254,0.28)", left: "rgba(147,197,253,0.24)", bottom: "rgba(30,64,175,0.3)", right: "rgba(30,58,138,0.32)" },
  { fill: "rgba(249,115,22,0.2)", top: "rgba(254,215,170,0.3)", left: "rgba(253,186,116,0.28)", bottom: "rgba(154,52,18,0.32)", right: "rgba(124,45,18,0.34)" },
  { fill: "rgba(74,222,128,0.18)", top: "rgba(187,247,208,0.28)", left: "rgba(134,239,172,0.24)", bottom: "rgba(21,128,61,0.3)", right: "rgba(22,101,52,0.32)" },
  { fill: "rgba(244,63,94,0.2)", top: "rgba(254,205,211,0.3)", left: "rgba(253,164,175,0.28)", bottom: "rgba(159,18,57,0.32)", right: "rgba(136,19,55,0.34)" },
];
...
/** Legacy teal SVG background (only loaded when not on cleanFlow). */
export function LegacyGeometricSvgBackground() {
